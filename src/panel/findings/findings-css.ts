...
export const FINDINGS_CSS = `
  .nimbus-findings { overflow-wrap: anywhere; }
  .nimbus-findings a { color: var(--nimbus-accent); text-decoration: none; }
  .nimbus-findings__gaps {
    margin: 8px 0 0;
    padding: 8px;
    border-radius: 4px;
    background: var(--nimbus-border);
  }
  .nimbus-findings__gap { margin: 0 0 4px; font-size: 12px; color: var(--nimbus-muted); }
